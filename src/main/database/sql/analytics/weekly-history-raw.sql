-- Returns one row per (week, card, member) for cards whose most recent
-- list-change action moved them to a "done" list within the past 12 months.
...
-- This determines whether the card is currently in a "done" state.
