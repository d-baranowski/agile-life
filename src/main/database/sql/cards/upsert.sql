...
INSERT INTO trello_cards
  (id, board_id, list_id, name, closed, date_last_activity, pos, short_url, labels_json, members_json)
VALUES
  (@id, @boardId, @listId, @name, @closed, @dateLastActivity, @pos, @shortUrl, @labelsJson, @membersJson)
