export const IPC_CHANNELS = {
  ...
  TRELLO_CREATE_LIST: 'trello:createList',
  TRELLO_ARCHIVE_LIST: 'trello:archiveList',
  TRELLO_REORDER_LIST: 'trello:reorderList',
  TRELLO_UPDATE_CARD_NAME: 'trello:updateCardName',
