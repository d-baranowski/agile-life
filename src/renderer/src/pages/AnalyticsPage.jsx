...
export default function AnalyticsPage({ board }) {
    ...
    return (<div className={styles.container}>
      ...
      {loading ? (<div className={styles.loading}>
        ...
        </div>) : weeklyStats.length === 0 && labelStats.length === 0 ? (<div className={styles.emptyState}>
          ...
          <section>
            ...
            {sortedUsers.length === 0 ? (<p className="text-muted">No data.</p>) : (<div className={styles.userList}>
          ...
          <section>
            ...
            {Object.keys(labelGroups).length === 0 ? (<p className="text-muted">
                No labelled tickets found. Labels are required for this breakdown.
              </p>) : (<div className={styles.labelList}>
          ...
          <section>
            <div className={styles.chartHeader}>
              ...
              {allHistoryWeeks.length > 0 && (<div className={styles.chartNav}>
                  <button className={styles.chartNavBtn} onClick={() => setHistoryOffset((o) => Math.min(o + 1, maxOffset))} disabled={clampedOffset >= maxOffset} title="Older">
                    ◀
                  </button>
                  <span className={styles.chartNavLabel}>{pageRangeLabel}</span>
                  <button className={styles.chartNavBtn} onClick={() => setHistoryOffset((o) => Math.max(o - 1, 0))} disabled={clampedOffset === 0} title="Newer">
                    ▶
                  </button>
                </div>)}
            </div>
